...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://wmagdaw.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("magda.zz@hotmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("moje_haslo");
